...
<head>
    ...
    <link rel="stylesheet" href="style.css">
	 ...
	 <script id='pixel-script-poptin' src='https://cdn.popt.in/pixel.js?id=9754746b01916' async='true'></script> 
                ...
                <div class="col-12 col-md-6">
                    <div class="about-content mb-100">
                        ...
                        <div class="section-heading">
                            ...
                            <h2>Happy shipping with few clicks..</h2>
                        </div>
                        <h6 class="mb-4">Deliver all your products to your destination with best price  </h6>
                        <p class="mb-0">we assure safe and secured delivery</p>
                        <a href="shipform.html" class="btn credit-btn mt-50">Discover</a>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="about-thumbnail mb-100">
                        <img src="img/bg-img/ship2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<!-- ##### FAQ Area End ###### -->
                ...
                <div class="col-12">
                    ...
                    <div class="cta-content d-flex flex-wrap align-items-center justify-content-between">
                        <div class="cta-text">
                            ...
                            <p>To safe and secure transportation of your goods use D2D.. </p>
                        </div>
                        <div class="cta-btn">
                            <a href="customer form.html" class="btn credit-btn box-shadow">ship now</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section  class="cta-area d-flex flex-wrap ">
        ...
        <div class="cta-content">
            <!-- Section Heading -->
            <img src="img/bg-img/hi.png" alt="" style="float: right;    max-width: 30%;
    width: 1000px;">
            <div class="section-heading white">
                <div class="line"></div>
				<h2>Responses from Transporter</h2>
                <h1 style="color: white;padding-bottom: 25px;
                padding-top: 20px;
                font-size: -webkit-xxx-large;">
			
			 <h5>Driver details</h5>
					<h6>Driver Id: <?php echo " ".$_SESSION['did']." ";?></h6>
					<h6>Name: <?php echo " ".$_SESSION['firstname']." ".$_SESSION['lastname']." ";  ?></h6> 
                    <h6>contact: <?php echo " ".$_SESSION['phone']." ";?></h6>
                     <h6>Email: <?php echo " ".$_SESSION['email']." ";?></h6>
			<h4  style="color: white;padding-bottom: 20px;
                padding-top: 20px;
               ">Amount for transport: <?php echo " ".$_SESSION['amount']." ";?></h4>
					
		   <a href="https://app.popt.in/APIRequest/click/d72247651c9a0" id="accept" class="btn credit-btn box-shadow btn-2 abcd">Accept </a>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="cta-content d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div class="cta-btn">
                            <a href="./payment/pay.php" class="btn credit-btn box-shadow">confirm and Pay Now</a>
                        </div>
                    </div>
                </div>
            </div>
